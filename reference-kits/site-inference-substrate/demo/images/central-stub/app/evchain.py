# SYNC NOTE: byte-identical copy of evidence-collector/app/evchain.py —
# the build contexts are separate images. tests/test_evchain.py fails if
# the two copies ever drift. Edit the collector copy; re-copy here.
